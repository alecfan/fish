            ...
            <div class="category">
              <ul class="category-list" id="js_climit_li">
                <li class="appliance js_toggle relative first">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/cake.png')}}"></i><a class="ml-22" title="点心">点心/蛋糕</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/cookies.png')}}"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/meat.png')}}"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/bamboo.png')}}"></i><a class="ml-22" title="素食、卤味">素食/卤味</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/nut.png') }}"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/candy.png') }}"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/chocolate.png') }}"></i><a class="ml-22" title="巧克力">巧克力</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/fish.png') }}"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/tea.png') }}"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
                ...
                <li class="appliance js_toggle relative last">
                  <div class="category-info">
                    <h3 class="category-name b-category-name">
                      <i><img src="{{ asset('home/images/package.png') }}"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a>
                    </h3>
                    <em>&gt;</em>
                  </div>
                  <div class="menu-item menu-in top">
