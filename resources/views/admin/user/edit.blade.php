...
<div class="main-content">
  <div class="page-content">
    ...
    <div class="row">
      <div class="col-xs-12">
        <form action="/admin/user/{{ $list->id }}" method='post' class="form-horizontal" role="form">
          {{ csrf_field() }} {{ method_field('PUT') }}
          <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 用户名 </label>
            <div class="col-sm-9">
              <input type="text" name="username" value="{{ $list->username }}" id="form-field-1" class="col-xs-10 col-sm-5" disabled/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="password" name="password" value="" id="form-field-2" placeholder="默认为不修改密码" class="col-xs-10 col-sm-5" />
            </div>
          </div>
          <div class="space-4"></div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select name="login" id="form-field-2" class="col-xs-10 col-sm-5">
                <option value="0" @if(($list->login) == '0') selected @endif >禁止登录</option>
                <option value="1" @if(($list->login) == '1') selected @endif >允许登录</option>
              </select>
            </div>
          </div>
